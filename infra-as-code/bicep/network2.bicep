...
var appGatewaySubnetPrefix = '10.1.1.0/24'
var appServicesSubnetPrefix = '10.1.0.0/24'
var privateEndpointsSubnetPrefix = '10.1.2.0/27'
var agentsSubnetPrefix = '10.1.2.32/27'
var bastionSubnetPrefix = '10.1.2.64/26'
var jumpboxSubnetPrefix = '10.1.2.128/28'
var trainingSubnetPrefix = '10.1.3.0/24'
var scoringSubnetPrefix = '10.1.4.0/24'
...
resource privateEndpointsSubnetNsg 'Microsoft.Network/networkSecurityGroups@2022-11-01' = {
  name: 'nsg-privateEndpointsSubnet-2'
  location: location
  properties: {
    securityRules: [
      {
